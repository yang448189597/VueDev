<template>
  <div id="app">
    ...
    <div @mouseleave="moveTableOutside">
      ...
      >
        <el-table-column fixed prop="projectname" label="项目名称" width="150" :resizable='false'></el-table-column>
        <el-table-column fixed prop="childprojectname" label="子项目名称" width="150" :resizable='false'></el-table-column>
        <el-table-column fixed prop="budget" label="预算" width="150" :resizable='false'></el-table-column>
        <el-table-column fixed prop="chargename" label="子项目负责人" width="150" :resizable='false'></el-table-column>
        <el-table-column
